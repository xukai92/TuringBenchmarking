...
#define main main(int argc, char **argv) { clock_t start_t, end_t, total_t; start_t = clock(); int re = program_execution_wrapper(argc, argv); end_t = clock(); total_t = end_t - start_t; printf("%lu", total_t); return re;} int __program
